...
#wave form script
add wave -position insertpoint -color "light blue" -radix unsigned -group CLK  	 sim:/tb_puf_soc_dta_pth/clk         
add wave -position insertpoint -color "light blue" -radix unsigned -group RST  	 sim:/tb_puf_soc_dta_pth/rst_n       
add wave -position insertpoint -color "light blue" -radix unsigned -group input  sim:/tb_puf_soc_dta_pth/i_op_mode   
add wave -position insertpoint -color "light blue" -radix unsigned -group input  sim:/tb_puf_soc_dta_pth/i_sipo_data 
add wave -position insertpoint -color "light blue" -radix unsigned -group input  sim:/tb_puf_soc_dta_pth/i_sipo_valid
...
add wave -position insertpoint -color "light blue" -radix unsigned -group input  sim:/tb_puf_soc_dta_pth/i_shft_en   
...
add wave -position insertpoint -color "light blue" -radix unsigned -group output  sim:/tb_puf_soc_dta_pth/o_sipo_ready
add wave -position insertpoint -color "light blue" -radix unsigned -group output  sim:/tb_puf_soc_dta_pth/o_sipo_valid
add wave -position insertpoint -color "light blue" -radix unsigned -group output  sim:/tb_puf_soc_dta_pth/o_sipo_data 
add wave -position insertpoint -color "light blue" -radix unsigned -group output  sim:/tb_puf_soc_dta_pth/o_exec_done 
add wave -position insertpoint -color "light blue" -radix unsigned -group output  sim:/tb_puf_soc_dta_pth/o_piso_ready
add wave -position insertpoint -color "light blue" -radix unsigned -group output  sim:/tb_puf_soc_dta_pth/o_piso_data 
add wave -position insertpoint -color "light blue" -radix unsigned -group output  sim:/tb_puf_soc_dta_pth/o_piso_valid
add wave -position insertpoint -color "light blue" -radix unsigned -group output  sim:/tb_puf_soc_dta_pth/o_piso_done
#sipo
...
add wave -position insertpoint -color "light blue" -radix unsigned -group SIPO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_sipo/i_valid
add wave -position insertpoint -color "light blue" -radix unsigned -group SIPO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_sipo/i_ready
add wave -position insertpoint -color "light blue" -radix unsigned -group SIPO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_sipo/i_data 
add wave -position insertpoint -color "light blue" -radix unsigned -group SIPO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_sipo/o_data 
add wave -position insertpoint -color "light blue" -radix unsigned -group SIPO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_sipo/o_ready
add wave -position insertpoint -color "light blue" -radix unsigned -group SIPO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_sipo/o_valid 
# Decoder
...
add wave -position insertpoint -color "light blue" -radix unsigned -group CONT0 sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_counter_0/i_en      
...
#count1       
add wave -position insertpoint -color "light blue" -radix unsigned -group CONT1 sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_counter_1/clk       
add wave -position insertpoint -color "light blue" -radix unsigned -group CONT1 sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_counter_1/rst_n     
add wave -position insertpoint -color "light blue" -radix unsigned -group CONT1 sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_counter_1/i_en      
add wave -position insertpoint -color "light blue" -radix unsigned -group CONT1 sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_counter_1/o_valid   
add wave -position insertpoint -color "light blue" -radix unsigned -group CONT1 sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_counter_1/o_cnt     
add wave -position insertpoint -color "light blue" -radix unsigned -group CONT1 sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_counter_1/o_cnt_full
# comparator
...
add wave -position insertpoint -color "light blue" -radix unsigned -group COMP sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_comparator/i_cnt0      
add wave -position insertpoint -color "light blue" -radix unsigned -group COMP sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_comparator/i_cnt1      
...
add wave -position insertpoint -color "light blue" -radix unsigned -group ASSEMBLE sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_assembler/i_sipo_data    
...
add wave -position insertpoint -color "light blue" -radix unsigned -group PISO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_piso/i_ld_data  
add wave -position insertpoint -color "light blue" -radix unsigned -group PISO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_piso/i_shft_en  
add wave -position insertpoint -color "light blue" -radix unsigned -group PISO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_piso/i_shft_mode
add wave -position insertpoint -color "light blue" -radix unsigned -group PISO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_piso/i_reg_data 
add wave -position insertpoint -color "light blue" -radix unsigned -group PISO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_piso/o_ready    
add wave -position insertpoint -color "light blue" -radix unsigned -group PISO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_piso/o_shift    
add wave -position insertpoint -color "light blue" -radix unsigned -group PISO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_piso/o_valid    
add wave -position insertpoint -color "light blue" -radix unsigned -group PISO sim:/tb_puf_soc_dta_pth/DUT/inst_puf_soc_piso/o_done     