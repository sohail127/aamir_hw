...
# Command Used: write_xdc -no_fixed_only -force ../../constraints/puf_ro_65_8_post_route.xdc
####################################################################################


####################################################################################
# Constraints from file : 'puf_ro_65_8.xdc'
####################################################################################
...
set_property BEL D6LUT [get_cells i_puf_cntr/o_valid_i_1]
set_property BEL B6LUT [get_cells i_puf_cntr/o_valid_i_2]
set_property BEL C5FF [get_cells i_puf_cntr/o_valid_reg]
set_property BEL DFF [get_cells i_puf_cntr/o_valid_reg_lopt_replica]
...
set_property BEL B6LUT [get_cells {i_puf_ro/w_ring[2]_inferred_i_1}]
set_property BEL C6LUT [get_cells {i_puf_ro/w_ring[3]_inferred_i_1}]
set_property BEL D6LUT [get_cells {i_puf_ro/w_ring[4]_inferred_i_1}]
set_property BEL A5LUT [get_cells {i_puf_ro/w_ring[5]_inferred_i_1}]
set_property BEL B5LUT [get_cells {i_puf_ro/w_ring[6]_inferred_i_1}]
...
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count[0]_i_1}]
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count[1]_i_1}]
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count[2]_i_1}]
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count[3]_i_1}]
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count[4]_i_1}]
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count_reg[0]}]
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count_reg[1]}]
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count_reg[2]}]
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count_reg[3]}]
set_property LOC SLICE_X0Y101 [get_cells {i_puf_cntr/o_count_reg[4]}]
set_property LOC SLICE_X0Y101 [get_cells i_puf_cntr/o_valid_i_1]
set_property LOC SLICE_X1Y101 [get_cells i_puf_cntr/o_valid_i_2]
set_property LOC SLICE_X0Y101 [get_cells i_puf_cntr/o_valid_reg]
set_property LOC SLICE_X0Y101 [get_cells i_puf_cntr/o_valid_reg_lopt_replica]
set_property LOC SLICE_X1Y101 [get_cells i_puf_ro/w_nand_inferred_i_1]
set_property LOC SLICE_X1Y101 [get_cells {i_puf_ro/w_ring[0]_inferred_i_1}]
set_property LOC SLICE_X1Y100 [get_cells {i_puf_ro/w_ring[1]_inferred_i_1}]
set_property LOC SLICE_X1Y100 [get_cells {i_puf_ro/w_ring[2]_inferred_i_1}]
set_property LOC SLICE_X1Y100 [get_cells {i_puf_ro/w_ring[3]_inferred_i_1}]
set_property LOC SLICE_X1Y101 [get_cells {i_puf_ro/w_ring[4]_inferred_i_1}]
set_property LOC SLICE_X1Y101 [get_cells {i_puf_ro/w_ring[5]_inferred_i_1}]
set_property LOC SLICE_X1Y101 [get_cells {i_puf_ro/w_ring[6]_inferred_i_1}]
...
set_property LOC SLICE_X1Y101 [get_cells reg_ro_reg]
