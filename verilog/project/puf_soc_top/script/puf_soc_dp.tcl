...
################################################################################
	...
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_sipo.v                             
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_ro_decoder.v                                  
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_comparator.v                       
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_ro_bank.v                                   
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_ro.v                                        
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_ro_not.v                               
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_mux.v                                    
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_counter.v                                   
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_assembler.v                                  
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_piso.v                                         
	add_files -fileset sources_1 ${WORK_DIR}/../../rtl/puf_soc_dta_pth.v                               
...
################################################################################
	...
	synth_design -top puf_soc_dta_pth -part $PART_NUMB 
