...
################################################################################
	#set atributes here
	set_property generic {CNT_BIT_SIZE=16} [current_fileset] 
	set_property generic {NO_PUF_STAGE=16} [current_fileset] 
	# set_property generic {REG_BIT_SIZE=8}  [current_fileset] 
	# set_property generic {MUX_IN_SIZ=1} 	 [current_fileset] 
	# set_property generic {MUX_LENGTH=16} 	 [current_fileset] 
	# set_property generic {PUF_LENGTH=16} 	 [current_fileset] 
	# set_property generic {FRAM_SIZE=160} 	 [current_fileset] 
	# set_property generic {NORM_MOD=34} 	 	 [current_fileset] 
	# set_property generic {DEBUG_MOD=133} 	 [current_fileset] 
	synth_design -top puf_soc_top -part $PART_NUMB 
  write_checkpoint 				-force ../../${PROJ_NAME}_rpt/${PROJ_NAME}_synth_rpt/post_synth.dcp
	...
	write_sdf 			-force ../../sdf/${PROJ_NAME}_post_synth_time_netlist.sdf
...
# ################################################################################
	...
	write_sdf 			-force ../../sdf/${PROJ_NAME}_post_impl_time_netlist.sdf
