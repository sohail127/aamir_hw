...
# add_files -fileset constrs_1 [glob "$WORK_DIR/../constraints/*.xdc"]
	update_compile_order -fileset sources_1

## 4. Run Synthesis 
	#set atributes here
	synth_design -top shift_register -part $PART_NUMB 
	# write_checkpoint -force $soucrce_dir/rpt/post_synth.dcp
	report_timing_summary -file ../../${PROJ_NAME}_synth_rpt/post_synth_timing_summary.rpt
	report_utilization 		-file ../../${PROJ_NAME}_synth_rpt/post_synth_util.rpt
	report_utilization 		-file ../../${PROJ_NAME}_synth_rpt/post_synth_critpath_report.csv
##  5. run logic optimization,placement
	opt_design
	# reportCriticalPaths 		../../${PROJ_NAME}_impl_rpt/post_opt_critpath_report.csv
	#placement
	place_design
	write_checkpoint 				-force ../../${PROJ_NAME}_impl_rpt/post_place.dcp
	report_clock_utilization -file ../../${PROJ_NAME}_impl_rpt/clock_util.rpt
	report_utilization 			 -file ../../${PROJ_NAME}_impl_rpt/post_place_util.rpt
	report_timing_summary 	 -file ../../${PROJ_NAME}_impl_rpt/post_place_timing_summary.rpt
#6. Route Design
	route_design
	write_checkpoint 			-force		../../${PROJ_NAME}_impl_rpt/post_route.dcp
	report_route_status 	-file  		../../${PROJ_NAME}_impl_rpt/post_route_status.rpt
	report_timing_summary -file  		../../${PROJ_NAME}_impl_rpt/post_route_timing_summary.rpt
	report_power 					-file  		../../${PROJ_NAME}_impl_rpt/post_route_power.rpt
	report_drc   					-file  		../../${PROJ_NAME}_impl_rpt/post_imp_drc.rpt
